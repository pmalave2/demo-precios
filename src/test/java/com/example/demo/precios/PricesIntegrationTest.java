...
import static com.example.demo.precios.TestUtils.PROFILE;
...
class PricesIntegrationTest {
  ...
  void givenPrice_whenGetPrice_thenReturnHttpCode200(String date, int productId, int brandId, int priceList,
      double price)
      throws Exception {
  ...
  void givenRequest_whenGetPriceFromBrandDontExists_thenReturnHttpCode404() throws Exception {
    ...
    params.replace("brandId", List.of("2"));
